                ...
                <div class="mt-4 mb-5">
                    <div class="flex flex-wrap justify-between">
                        ...
                        <div class="text-right md:w-1/2">
                            ...
                            <a href="{{ route('communities.create') }}" class="button button-primary">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-left">
                                    <a href="mailto:{{ $community->email }}"
                                        style="color: blue">{{ $community->email ?? '-' }}</a>
                                </td>
                                <td class="px-4 py-3 text-left">
                                    {{ $community->country ?? '-' }}
                                </td>
                                <td class="px-4 py-3 text-left">
                                    <a href="https://wa.me/{{ $community->phone_number }}" target="_blank"
                                ...
                                <td class="px-4 py-3 text-center" style="width: 134px;">
                                    <div role="group" aria-label="Row Actions"
                                        ...
                                        <a href="{{ route('communities.edit', $community) }}" class="mr-1">
                                            <button type="button" class="button">
                                                <i class="icon ion-md-create"></i>
                                            </button>
                                        </a>
                                        @endcan @can('view', $community)
                                        <a href="{{ route('communities.show', $community) }}" class="mr-1">
                                            <button type="button" class="button">
                                        ...
                                        <form action="{{ route('communities.destroy', $community) }}"
                                            ...
                                            <button type="submit" class="button">
                                                <i class="text-red-600  icon ion-md-trash"></i>
                                            </button>
                                        </form>
                                        @endcan
                                    </div>
