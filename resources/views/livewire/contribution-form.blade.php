...
<div class="col-12">
    <div class="form-group">
        <h5>Every year or Every month</h5>
        ...
        <div class="row" style="row-gap: 22px;">
            <div class="col-lg-6">
                ...
                <select wire:model="title" class="form-control">
                    <option>select title here</option>
...
<div class="col-12">
    <div class="form-group">
        <div class="row" style="row-gap: 22px;">
            ...
            <div class="col-lg-6">
                <h5>Phone Number</h5>
                <input wire:model="phoneNumber" id="mobile_code_1" type="tel" min="0" class="form-control">
...
<script>
    const input_2 = document.querySelector("#mobile_code_1");
