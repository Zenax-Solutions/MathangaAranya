...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-md-4 mb-4">
      <a href="{{\Storage::url($data->image)}}" data-lightbox="gallery" data-title="{{$data->title ?? '-'}}">
        <img style="height: 380px; width: 380px; object-fit: cover;" src="{{\Storage::url($data->image)}}" class="img-fluid rounded">
      </a>
    </div>
