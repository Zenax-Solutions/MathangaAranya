    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-7 d-none d-lg-block">
                ...
                <div>
                    <iframe width="100%" height="400px" style="border-radius:5px" src="https://www.youtube.com/embed/uU-jwqHomoo?si=nvyUk1XlZnoMwX08" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="sigma_service style-2">
                    ...
                    <div class="sigma_service-body">
                        ...
                        <p style="visibility:hidden">{{ \Str::limit(strip_tags($event->description), 100, ' ...') }}</p>
